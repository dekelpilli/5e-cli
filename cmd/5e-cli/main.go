...
var COMMAND_MAP = map[string]CommandFunc{
	...
	"shrine":           shrine,
	"carnival":         carnival,
	"npc":              drawVM("NPC", "gender", "race"),
	"skill":            drawVM("Skill", "skill"),
	"dmg type":         drawVM("Damage type", "dmg-type"),
	"creature type":    drawVM("Creature type", "creature-type"),
	"ability":          drawVM("Ability", "ability"),
	"condi":            drawVM("Condition", "condition"),
	"dmg polarity":     drawVM("Damage polarity", "dmg-polarity"),
	"party member":     drawVM("Party member", "party-member"),
	"xiloan":           drawVM("Xiloan", "xiloan"),
	"weapon class":     drawVM("Weapon class", "weapon-class"),
	"phys type":        drawVM("Physical damage type", "phys-type"),
	"non-phys type":    drawVM("Non-physical damage type", "non-phys-type"),
	"class":            drawVM("Class", "class"),
	"feat":             drawVM("Feat", "feat"),
	"simple wep":       drawVM("Simple weapon", "simple-weapon"),
	"martial wep":      drawVM("Martial weapon", "martial-weapon"),
	"language":         drawVM("Language", "language"),
	"plane":            drawVM("Plane", "plane"),
	"affinity":         drawVM("Affinity", "affinity"),
	"trait":            drawVM("Weapon trait", "weapon-trait"),
	"loot result":      drawVM("Loot result", "loot-result"),
	"journey activity": drawVM("Journey activity", "journey-activity"),
	"augment":          augment,
	"boon":             riverviewBoon,
}
